...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            ...
            <li class="nav-item"><a class="nav-link" href="vista.php"><span>Vista de Pedidos</span> </a></li>
            <li class="nav-item"><a class="nav-link active" href="finished.php"><span>Vista de Pedidos Terminados</span></a></li>
